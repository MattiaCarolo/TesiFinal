...
class PerformanceRNN(nn.Module):
    def __init__(self, event_dim, control_dim, init_dim, hidden_dim,
        ...
        self.event_dim = event_dim # EventSeq.dim 240 collezione degli eventi raccolti durante la creazione del dataset
        self.control_dim = control_dim # ControlSeq.dim 24 varie durate e cambi trovati durante il preprocess
        self.init_dim = init_dim # Dimensione tensore per inizializzare la generazione
        self.hidden_dim = hidden_dim # Dimensione hidden layer
